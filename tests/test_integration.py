...
Skipped unless all LLM_INTERACTION_* env vars are set.

Run with:
    pytest tests/test_integration.py -v

Or explicitly:
    LLM_INTERACTION_API_KEY=... LLM_INTERACTION_ENDPOINT=... LLM_INTERACTION_MODEL=... pytest tests/test_integration.py -v
"""
...
skip_no_llm = pytest.mark.skipif(
    ...
    reason="LLM_INTERACTION_* env vars not set",
)
...
def llm(tmp_path):
    ...
    return LLMInteraction(prompt_dir=tmp_path)
